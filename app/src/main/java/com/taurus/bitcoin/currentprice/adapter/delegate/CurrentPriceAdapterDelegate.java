...
public class CurrentPriceAdapterDelegate
    extends BaseAdapterDelegate<RateUIModel, GenericItem, CurrentPriceViewHolder> {
  ...
  protected CurrentPriceViewHolder onCreateViewHolder(@NonNull ViewGroup parent) {
    return new CurrentPriceViewHolder(parent, R.layout.list_item_current_price,
        getOnItemClickListener());
  }

  @Override protected void onBindViewHolder(@NonNull RateUIModel item,
      @NonNull CurrentPriceViewHolder viewHolder, @NonNull List<Object> payloads) {
